...
//     // Judul
//     $sheet->mergeCells('A1:P1');
//     $sheet->setCellValue('A1', "Rekap Penimbangan / Pengukuran Usia Dewasa dan Lansia - Tahun {$tahun}");
//     $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(14);
//     $sheet->getStyle('A1')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
...
//         // Kalau benar-benar tidak ada pemeriksaan bulan itu, tetap tulis baris dengan 0
//         if ($agg && $agg->total_pemeriksaan > 0) {
//             $adaData = true;
//         }
...
//         $sheet->setCellValue("B{$row}", (int)($agg->imt_sangat_kurus ?? 0));
//         $sheet->setCellValue("C{$row}", (int)($agg->imt_kurus ?? 0));
//         $sheet->setCellValue("D{$row}", (int)($agg->imt_normal ?? 0));
//         $sheet->setCellValue("E{$row}", (int)($agg->imt_gemuk ?? 0));
//         $sheet->setCellValue("F{$row}", (int)($agg->imt_obesitas ?? 0));

//         $sheet->setCellValue("G{$row}", (int)($agg->lp_laki ?? 0));
//         $sheet->setCellValue("H{$row}", (int)($agg->lp_perempuan ?? 0));

//         // TD rendah masih 0
//         $sheet->setCellValue("I{$row}", 0);
//         $sheet->setCellValue("J{$row}", (int)($agg->td_normal ?? 0));
//         $sheet->setCellValue("K{$row}", (int)($agg->td_tinggi ?? 0));

//         // GD rendah masih 0
//         $sheet->setCellValue("L{$row}", 0);
//         $sheet->setCellValue("M{$row}", (int)($agg->gd_normal ?? 0));
//         $sheet->setCellValue("N{$row}", (int)($agg->gd_tinggi ?? 0));

//         $sheet->setCellValue("O{$row}", (int)($agg->puma_normal ?? 0));
//         $sheet->setCellValue("P{$row}", (int)($agg->puma_tinggi ?? 0));
...
// }
    ...
    //     // Header baris 2: kiri Dewasa+Lansia umum, kanan Lansia khusus
    //     $sheet->mergeCells('B2:P2');
    //     $sheet->setCellValue('B2', 'Usia Dewasa dan Lansia');
    //     $sheet->getStyle('B2:P2')->getAlignment()
    //         ->setHorizontal(Alignment::HORIZONTAL_CENTER)
    ...
    //     $sheet->mergeCells('Q2:AJ2');
    //     $sheet->setCellValue('Q2', 'Lansia');
    //     $sheet->getStyle('Q2:AJ2')->getAlignment()
    //         ->setHorizontal(Alignment::HORIZONTAL_CENTER)
    //         ->setVertical(Alignment::VERTICAL_CENTER);
    //     $sheet->getStyle('Q2:AJ2')->getFont()->setBold(true);

    //     // Baris 3 kiri: IMT, Lingkar Perut, TD, GD, PUMA
    //     $sheet->mergeCells('B3:F3')->setCellValue('B3', 'IMT');
    //     $sheet->mergeCells('G3:H3')->setCellValue('G3', 'Lingkar Perut');
    //     $sheet->mergeCells('I3:K3')->setCellValue('I3', 'Tekanan Darah');
    //     $sheet->mergeCells('L3:N3')->setCellValue('L3', 'Gula Darah');
    ...
    //     // Baris 3 kanan: AKS, SKILAS, Tindak Lanjut
    //     $sheet->mergeCells('Q3:U3')->setCellValue('Q3', 'Tingkat Ketergantungan (AKS)');
    //     $sheet->mergeCells('V3:AG3')->setCellValue('V3', 'Skrining Lansia Sederhana (SKILAS)');
    //     $sheet->mergeCells('AH3:AJ3')->setCellValue('AH3', 'Tindak Lanjut');

    //     $sheet->getStyle('B3:AJ3')->getAlignment()
    //         ->setHorizontal(Alignment::HORIZONTAL_CENTER)
    //         ->setVertical(Alignment::VERTICAL_CENTER)
    //         ->setWrapText(true);
    //     $sheet->getStyle('B3:AJ3')->getFont()->setBold(true);

    //     // Baris 4: label kecil (kolom 2–36)
    //     $headers = [
    //         // Tahap 1 (IMT, LP, TD, GD, PUMA)
    //         'B4'  => 'Sangat Kurus',
    //         'C4'  => 'Kurus',
    //         'D4'  => 'Normal',
    //         'E4'  => 'Gemuk',
    ...
    //         // Tahap 2 – SKILAS Kognitif (Ya/Tidak)
    //         'V4'  => "Kognitif\nYa",
    //         'W4'  => "Kognitif\nTidak",
    ...
    //     $sheet->getStyle('B4:AJ4')->getAlignment()
    //         ->setHorizontal(Alignment::HORIZONTAL_CENTER)
    //         ->setVertical(Alignment::VERTICAL_CENTER)
    //         ->setWrapText(true);
    //     $sheet->getStyle('B4:AJ4')->getFont()->setBold(true);
    ...
    //         // ---------- AGREGAT DEWASA (tahap 1 + edukasi + rujuk) ----------
    ...
    //             // SKILAS – Kognitif (di kode sebelumnya: 0 = gangguan → "Ya")
    ...
    //             // Pendengaran → tes bisik (0 = masalah → "Ya")
    ...
    //             // Penglihatan → masalah pada mata (1) atau tes melihat 0
    ...
    //             // Depresi → perasaan sedih atau sedikit minat (1)
    ...
    //             // Dirujuk lansia: AKS atau SKILAS rujuk otomatis/manual
    //             ->selectRaw("
    //                 SUM(
    ...
    //         if ($aggD && $aggD->total_pemeriksaan > 0) {
    //             $adaData = true;
    //         }
    //         if ($aggL && $aggL->total_lansia > 0) {
    //             $adaData = true;
    //         }

    //         $bulanNama = $start->translatedFormat('F Y');

    //         // ====== ISI TAHAP 1 (kolom A–P) ======
    //         $sheet->setCellValue("A{$row}", $bulanNama);
    ...
    //         // ====== ISI TAHAP 2 (kolom Q–AJ) DARI LANSIA ======
    //         // AKS
